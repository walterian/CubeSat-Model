...
HD_PWD='E:/MATLAB/Clean_HDL/hdl_prj/vivado_prj/HDL_DUT_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDL_DUT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDL_DUT.tcl -notrace
