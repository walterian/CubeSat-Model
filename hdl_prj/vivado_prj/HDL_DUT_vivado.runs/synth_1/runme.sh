...
HD_PWD='E:/MATLAB/Clean_HDL/hdl_prj/vivado_prj/HDL_DUT_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDL_DUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDL_DUT.tcl
